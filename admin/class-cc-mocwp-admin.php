 ...
 *
 * @package   Community_Commons_MoCWP_Admin
 * @author  dcavins
 */
class CC_MoCWP_Admin {
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_slug ) . '">' . __( 'Settings', 'cc-mocwp' ) . '</a>'
			),
			$links
		);
	...
	public function report_custom_plugin( $custom_plugins, $group_id ) {
		if ( $group_id == mocwp_get_group_id() ) {
			$custom_plugins[] = "CC MoCWP";
		}
